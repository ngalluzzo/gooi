...
export const certificationContracts = Object.freeze({
	...
	certificationTrustPolicySchema: model.certificationTrustPolicySchema,
	...
	missingRequiredTrustClaimIds: policy.missingRequiredTrustClaimIds,
	trustDecisionMatchesRelease: policy.trustDecisionMatchesRelease,
	isTrustedVerdictSatisfied: policy.isTrustedVerdictSatisfied,

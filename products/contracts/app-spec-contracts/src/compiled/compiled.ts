...
export interface CompiledEntrypointBundle {
	...
	/** Projection IR consumed by projection query execution. */
	readonly projectionIR: CompiledProjectionIR;
	/** Render IR consumed by render kernels. */
	readonly viewRenderIR: CompiledViewRenderIR;
	/** Domain runtime IR consumed by domain mutation/query execution. */
	readonly domainRuntimeIR: CompiledDomainRuntimeIR;
	/** Session IR consumed by runtime session-policy evaluation. */
	readonly sessionIR: CompiledSessionIR;
	/** Scenario IR consumed by scenario runtime and conformance suites. */

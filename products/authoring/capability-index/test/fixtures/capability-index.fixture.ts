...
/**
 * Fixture build input used to generate deterministic capability index artifacts.
 */
export const capabilityIndexBuildFixture: BuildCapabilityIndexSnapshotInput = {
